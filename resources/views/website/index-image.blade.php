...
<head>
	...
	<!-- CSS Base -->
	<link rel="stylesheet" class="back-color" href="website/css/style-dark.css">
				...
				<div id="portfolio">
					<div id="blog">
						<div id="contact">
							...
							<!-- Home Section -->
							<div class="pt-home" style="background-image: url('website/img/bg.jpg')">
								<section>

									<!-- Banner -->
									<div class="banner">
										<h1>Sudan Upadhaya</h1>
											...
											<div class="info box-1">
												<div class="row">
													...
													<div class="col-lg-9 col-sm-8">
														<h4>Sudan Upadhaya</h4>
														<div class="loc">
															<i class="fas fa-map-marked-alt"></i> Kathmandu, Nepal
														</div>
														<p></p>
													</div>
